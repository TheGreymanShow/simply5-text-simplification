...
def simply5(raw):
    ...
    dataset = pd.read_csv("C:/xampp/htdocs/simply5/new_dictionary.csv")
    dictionary=[[] for x in range(4274)]
    
    irregular_verbs = pd.read_csv("C:/xampp/htdocs/simply5/Irregular_verbs.csv")
...
output=simply5("In todays computer world, a floppy disk is an anachronism.")
print(output)
